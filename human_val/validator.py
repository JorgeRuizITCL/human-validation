...
class Validator:
    ...
    """
    def __init__(self, model_path: str, onnx_providers: Any = None, min_conf_thres: float = 0.5) -> None:
        """_summary_
    ...
    def from_movenet_lightning(onnx_providers: Any = None, min_conf_thres: float = 0.5):
        ...
        return Validator(str(path), onnx_providers=onnx_providers, min_conf_thres=min_conf_thres)
